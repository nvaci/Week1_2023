...
1. Explain and motivate the linear regression model and how it relates to other statistical methods <br/> <br/> 
...
Weight: Comparing babies that have **.red[same Age]**, but differ on their **.red[Weight by one gram]**, the model predicts difference by a value of $\beta_2$ in their Height on average
...
3. Prepare for discussion for next week! 
